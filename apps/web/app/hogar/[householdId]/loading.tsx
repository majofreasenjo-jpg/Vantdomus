...
/**
 * Loader de la home companion (CP1c). Reemplaza el skeleton antiguo (que se veía
 * como una "página vieja azul" con el navbar durante la transición). Fondo cálido
 * de Domi + orbe latiendo. Usa id="vantdomus-app" para que la regla global
 * `body:has(#vantdomus-app) .nav{display:none}` oculte el navbar también mientras
 * carga, evitando el flash de chrome antiguo.
 */
export default function Loading() {
  return (
    ...
    >
      ...
      <div style={{ color: "#6b6795", fontSize: 14, fontWeight: 500, letterSpacing: ".2px" }}>
        Domi está preparando tu hogar…
      </div>
    </div>
  );
}
